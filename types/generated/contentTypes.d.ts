...
export interface ApiActividadActividad extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Actividades programadas en el camping (estructura pendiente).';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::actividad.actividad'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Testing: Schema.Attribute.String;
    Testingfield: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiGaleriaGaleria extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Galer\u00EDa multimedia del camping (a definir).';
    displayName: 'Galer\u00EDa';
    pluralName: 'galerias';
...
export interface ApiHorarioHorario extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Configuraci\u00F3n horaria del camping (sin campos a\u00FAn).';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::horario.horario'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiInstalacionInstalacion extends Struct.CollectionTypeSchema {
  collectionName: 'instalaciones';
  info: {
    description: 'Instalaciones del camping (pendiente de definir campos).';
    displayName: 'Instalaciones';
    pluralName: 'instalaciones';
    singularName: 'instalacion';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::instalacion.instalacion'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::instalacion.instalacion': ApiInstalacionInstalacion;
